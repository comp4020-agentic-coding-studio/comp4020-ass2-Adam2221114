...
// provisioned, and no other course in the cohort has them; the first digit
// is the postgraduate level chosen in Phase 1 of CLAUDE.md.
export const courseMeta = slopCourseMetaSchema.parse({
  ...
  endDate: "2027-05-28",
  description:
    "A postgraduate seminar on why apologies succeed or fail. Students " +
    "diagnose real apologies for their components, motives, timing and " +
    "power, then design and defend responses of their own, building " +
    "toward what a perfect apology would even mean.",
